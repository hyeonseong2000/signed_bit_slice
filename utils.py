...
class AverageMeter(object):
    ...
    def update2(self, result, gpu_time, data_time, n=1):
        self.count += n
...
def merge_into_row_with_gt(input, depth_input, depth_target, depth_pred):
    ...
    #print(rgb.shape, depth_input_col.shape, depth_target_col.shape, depth_pred_col.shape)
...
def init_or_load_model_quant(
    ...
    model = depthmodel(type = type, n_exp = n_exp, n_man= n_man , mode = mode, device = device)
