...
def main():
    ...
    model = DispNetS_Q_full_encoding(type = args.dtype, n_exp_en = args.exp_en, n_man_en =args.mant_en, n_exp_de = args.exp_de , n_man_de = args.mant_de, slice_width = args.slice_width ,mode = args.mode, device = "cuda" )
